...
1.1 Use */help* command to get a list of commands with their description
2. Setup your schedule via */set_schedule* command. Schedule defines the time bot can send you messages. 
2.1 Check your schedule via *my_schedule* command
3. Get the new song score (notes) as a challenge via */next* command
4. Play a song and record it as an audio message
5. Get a full song name, after the audio recording is send 
6. Receive a numerical feedback from another user
7. Move to step 3
...
Full use process and system behaviour can be found in page ** of the the artifact 
...
Should you have any concern regarding contribution to this project, do not hesitate to contact *email*.
